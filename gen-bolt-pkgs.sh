...
Options:
  ...
  --bolt-repo-sync-params PARAMS  BOLT_REPO_SYNC_PARAMS
  --bolt-dl-dir DIR               BOLT_DL_DIR (download directory)
  --bolt-sstate-dir DIR           BOLT_SSTATE_DIR (shared state cache)
...
[ -n "$CLI_BOLT_REPO_SYNC_PARAMS" ] && BOLT_REPO_SYNC_PARAMS="$CLI_BASE_REPO_SYNC_PARAMS"
[ -n "$CLI_BOLT_DL_DIR" ] && BOLT_DL_DIR="$CLI_BASE_DL_DIR"
[ -n "$CLI_BOLT_SSTATE_DIR" ] && BOLT_SSTATE_DIR="$CLI_BASE_SSTATE_DIR"
...
BOLT_ENV_CONTENT="BOLT_REPO_SYNC_PARAMS=\"${BASE_REPO_SYNC_PARAMS}\"
BOLT_DL_DIR=${BASE_DL_DIR}
BOLT_SSTATE_DIR=${BASE_SSTATE_DIR}"
